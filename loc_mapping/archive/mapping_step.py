...
# parse the results
# NOTE: the mapping and parsing steps were split for debugging
# in the final version, parsing will be run after mapDaneCountyLocation() is called
parsedResults = []
ct = -1
...
df_results = pd.read_csv('parsed_matched_mapped.txt', sep='\t')
df_results_nerNames = df_results['NER_term'].tolist()
