...
df = pd.read_csv(args.outbreak, delimiter='|', encoding='latin1')
...
"""
TODO:
include argparse, merge with parse_addresses.py to use full ShortFields
dataset, this will streamline workflow
"""

# import ShortFields notes file and parse similar to above
# df = pd.read_csv('NLP_RiskAndInterventionShortFields_20210201_160259.addresses.133245_0311.txt', delimiter='|', encoding='latin1')
df_pt = pd.read_csv(args.cases, sep="|", encoding="iso-8859-1", error_bad_lines=False, warn_bad_lines=False)
